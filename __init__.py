...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>python-xml2dict/__init__.py at master · yangchao228/python-xml2dict</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="72D4541C:5774:14389BF:52C27C2E" name="octolytics-dimension-request_id" /><meta content="6291049" name="octolytics-actor-id" /><meta content="panpannju" name="octolytics-actor-login" /><meta content="ef3fa5d67362415b87346a89c138aa3ccccc1eab53f0503b3cf85cf64efde9ba" name="octolytics-actor-hash" />
...
<meta content="jcWwFRDpzVbBvA6vFwdLSNC6JDq0SmgNHp0O9EQ9X8M=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-b64d0ad5fa62a30a166145ae08b8c0a6d2f7dea7.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="8983adfc0294e4e53e92b27093d9e927">
        ...
        <link data-pjax-transient rel='permalink' href='/yangchao228/python-xml2dict/blob/2d86f76440642ca9b68effe1a7c223978fef3d51/__init__.py'>
...
<!-- blob contrib key: blob_contributors:v21:49b5a0551bd5193f9bd9b1d11d7dce9a -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/yangchao228/python-xml2dict/blob/master/__init__.py"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <a class="minibutton tooltipped leftwards"
               href="http://windows.github.com" title="Open this file in GitHub for Windows">
                ...
                <a class="minibutton tooltipped upwards"
                   ...
                   href="/yangchao228/python-xml2dict/edit/master/__init__.py"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/yangchao228/python-xml2dict/raw/master/__init__.py" class="button minibutton " id="raw-url">Raw</a>
            <a href="/yangchao228/python-xml2dict/blame/master/__init__.py" class="button minibutton ">Blame</a>
          <a href="/yangchao228/python-xml2dict/commits/master/__init__.py" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/yangchao228/python-xml2dict/delete/master/__init__.py"
...
<span id="L38" rel="#L38">38</span>
            ...
            <td class="blob-line-code">
                    <div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c">#!/usr/bin/env python</span></div><div class='line' id='LC2'><span class="c"># -*- coding: UTF-8 -*-</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="sd">&#39;&#39;&#39;</span></div><div class='line' id='LC5'><span class="sd">XML2Dict: Convert xml and python dict</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="sd">@since: Created on 2009-5-18</span></div><div class='line' id='LC8'><span class="sd">@author: Mc.Spring</span></div><div class='line' id='LC9'><span class="sd">@contact: Heresy.Mc@gmail.com</span></div><div class='line' id='LC10'><span class="sd">@copyright: Copyright (C) 2009 MC.Spring Team. All rights reserved.</span></div><div class='line' id='LC11'><span class="sd">@license: http://www.apache.org/licenses/LICENSE-2.0 Apache License</span></div><div class='line' id='LC12'><span class="sd">&#39;&#39;&#39;</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'><span class="n">__version__</span> <span class="o">=</span> <span class="s">&#39;0.2.1&#39;</span></div><div class='line' id='LC15'><span class="n">__all__</span> <span class="o">=</span> <span class="p">[</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">&#39;parsexml&#39;</span><span class="p">,</span> <span class="s">&#39;parsedict&#39;</span><span class="p">,</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">&#39;XML2Dict&#39;</span><span class="p">,</span> <span class="s">&#39;Dict2XML&#39;</span><span class="p">,</span></div><div class='line' id='LC18'><span class="p">]</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><span class="n">__author__</span> <span class="o">=</span> <span class="s">&#39;Mc.Spring &lt;Heresy.Mc@gmail.com&gt;&#39;</span></div><div class='line' id='LC21'><br/></div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'><span class="kn">from</span> <span class="nn">encoder</span> <span class="kn">import</span> <span class="n">XML2Dict</span></div><div class='line' id='LC24'><span class="kn">from</span> <span class="nn">decoder</span> <span class="kn">import</span> <span class="n">Dict2XML</span></div><div class='line' id='LC25'><br/></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="k">def</span> <span class="nf">parsexml</span><span class="p">(</span><span class="n">s</span><span class="p">,</span> <span class="n">cls</span> <span class="o">=</span> <span class="bp">None</span><span class="p">):</span></div><div class='line' id='LC28'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="n">cls</span> <span class="ow">is</span> <span class="bp">None</span><span class="p">:</span></div><div class='line' id='LC29'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">cls</span> <span class="o">=</span> <span class="n">XML2Dict</span></div><div class='line' id='LC30'><br/></div><div class='line' id='LC31'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="n">cls</span><span class="p">()</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="n">s</span><span class="p">)</span></div><div class='line' id='LC32'><br/></div><div class='line' id='LC33'><br/></div><div class='line' id='LC34'><span class="k">def</span> <span class="nf">parsedict</span><span class="p">(</span><span class="n">d</span><span class="p">,</span> <span class="n">cls</span> <span class="o">=</span> <span class="bp">None</span><span class="p">):</span></div><div class='line' id='LC35'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="n">cls</span> <span class="ow">is</span> <span class="bp">None</span><span class="p">:</span></div><div class='line' id='LC36'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">cls</span> <span class="o">=</span> <span class="n">Dict2XML</span></div><div class='line' id='LC37'><br/></div><div class='line' id='LC38'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="n">cls</span><span class="p">()</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="n">d</span><span class="p">)</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.05271s from github-fe136-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
